...
namespace StorageAccount.Repository
{
    ...
    {
        static string connectionString="DefaultEndpointsProtocol=https;AccountName=storagesandy;AccountKey=kTdIlgRcrgW/aIUznhzJTkIXGaDq0U3tHmBz6upqah6h2Dz42hzHtTV2PK2Et1YvaePfgxe5Mde7+AStyMwSxQ==;EndpointSuffix=core.windows.net";
        ...
        public static async Task<BlobProperties> DownloadBlob(string blobName,string file)
        {
            try
            {
                string path=@"C:\Users\vmadmin\Desktop\StorageAccountDemo\StorageAccount\Downloads\"+blobName;
                BlobContainerClient container=new BlobContainerClient(connectionString,blobName);
